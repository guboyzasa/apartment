                        ...
                        <div class="card-body">
                            <div class="text-center" style="display: flex; justify-content: space-between;">
                                <div style="margin: auto;">
                                    <p class="text-dark font-size-24 b"><b>สัญญาเช่า<br>{{ $wtk->name }}</b></p>
                                    <p class="font-size-14">{{ $wtk->address }}
                                        {{ $wtk->address2 }}<br>
                                        {{ $wtk->phone }}</p>
                                    {{-- </p> --}}
                                </div>
                            ...
                            <form class="row g-3 mt-3">
                                @csrf
                                <input type="hidden" lass="form-control" id="CompanyID" value="{{ $wtk->id }}">
                                <div class="col-md-4">
